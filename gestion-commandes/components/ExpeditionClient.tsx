    ...
    <div>
      <div className="page-header">
        ...
        <button className="btn-primary" onClick={chargerSuivi} disabled={suiviEnCours}>
          {suiviEnCours ? L("Actualisation...", "\u062C\u0627\u0631\u064D \u0627\u0644\u062A\u062D\u062F\u064A\u062B") : L("Actualiser le suivi", "\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u062A\u0628\u0639")}
        </button>
      </div>
          ...
          <table>
            ...
            <tbody>
              {orders.map((o) => {
                ...
                const verrouille = !!o.senditCode;

                return (
                  <tr key={o.id} style={{ opacity: verrouille ? 0.8 : 1 }}>
                    <td>{o.numero}</td>
                    <td>
                      <input
                    ...
                    <td>
                      {o.senditCode ? (
                        ...
                        <button
                          ...
                          disabled={envoi === o.id}
                        >
                          {envoi === o.id ? L("Envoi...", "\u062C\u0627\u0631\u064D") : L("Envoyer a Sendit", "\u0625\u0631\u0633\u0627\u0644")}
                        </button>
                      )}
                    </td>
                  </tr>
