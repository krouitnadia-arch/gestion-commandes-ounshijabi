...
export default function AccueilClient({ nom, role }: { nom: string; role: string }) {
  ...
  const rubriques = [
    ...
    },
    {
      ...
      fr: "Magasin",
      ar: "\u0627\u0644\u0645\u062A\u062C\u0631",
      descFr: "Ventes en boutique, charges et stock du magasin",
      descAr: "\u0645\u0628\u064A\u0639\u0627\u062A \u0648\u0645\u0635\u0627\u0631\u064A\u0641 \u0627\u0644\u0645\u062A\u062C\u0631",
      Icone: IconeMagasin,
  ...
  function indicateurs(): Indicateur[] {
    ...
    if (onglet === "magasin")
      return [
        {
          libelle: L("Revenu net du magasin", "\u0635\u0627\u0641\u064A \u0627\u0644\u0645\u062A\u062C\u0631"),
          valeur: d.magasin.netMois,
          couleur: ROSE_FONCE,
          note: L("ventes - charges", "\u0627\u0644\u0645\u0628\u064A\u0639\u0627\u062A \u0646\u0627\u0642\u0635 \u0627\u0644\u0645\u0635\u0627\u0631\u064A\u0641"),
        },
        {
          libelle: L("Charges du mois", "\u0645\u0635\u0627\u0631\u064A\u0641 \u0627\u0644\u0634\u0647\u0631"),
          valeur: d.magasin.chargesMois,
          couleur: "#b91c1c",
          note: L(`${d.magasin.nbCharges} charge(s)`, `${d.magasin.nbCharges}`),
        },
        {
          libelle: L("Ventes du mois", "\u0645\u0628\u064A\u0639\u0627\u062A \u0627\u0644\u0634\u0647\u0631"),
          valeur: d.magasin.caMois,
          note: L(`${d.magasin.nombre} vente(s)`, `${d.magasin.nombre}`),
        },
        {
        ...
        {
          libelle: L("Charges aujourd'hui", "\u0645\u0635\u0627\u0631\u064A\u0641 \u0627\u0644\u064A\u0648\u0645"),
          valeur: d.magasin.chargesJour,
          couleur: "#b91c1c",
        },
        {
