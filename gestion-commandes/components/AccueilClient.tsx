...
export default function AccueilClient({ nom }: { nom: string }) {
  ...
  function indicateurs(): Indicateur[] {
    ...
    if (onglet === "ca")
      return [
        {
          libelle: L("Ce mois (articles seuls)", "\u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631"),
          valeur: d.chiffreAffaires.mois,
          couleur: ROSE_FONCE,
          note: L("hors frais de livraison", "\u0628\u062F\u0648\u0646 \u0627\u0644\u062A\u0648\u0635\u064A\u0644"),
        },
        {
          libelle: L("Cette semaine", "\u0647\u0630\u0627 \u0627\u0644\u0623\u0633\u0628\u0648\u0639"),
          valeur: d.chiffreAffaires.semaine,
        },
        {
          libelle: L("Aujourd'hui", "\u0627\u0644\u064A\u0648\u0645"),
          valeur: d.chiffreAffaires.jour,
        },
        {
          libelle: L("Frais de livraison du mois", "\u0631\u0633\u0648\u0645 \u0627\u0644\u062A\u0648\u0635\u064A\u0644"),
          valeur: d.chiffreAffaires.fraisMois,
          couleur: "#0369a1",
          note: L("payes a Sendit", "\u062A\u062F\u0641\u0639 \u0644\u0633\u0646\u062F\u064A\u062A"),
        },
      ];
    ...
    if (onglet === "magasin")
      return [
        ...
        {
          libelle: L("Reste a encaisser", "\u0627\u0644\u0628\u0627\u0642\u064A"),
    ...
    return [
      ...
      {
        libelle: L("Pieces disponibles", "\u0627\u0644\u0642\u0637\u0639"),
          ...
          >
            ...
            >
              {indicateurs().map((i, index) => (
                ...
                >
                  <div style={{ fontSize: 12, color: "#8a6b6c", fontWeight: 600 }}>{i.libelle}</div>
                  <div
                    style={{
                      fontSize: 26,
                      fontWeight: 800,
