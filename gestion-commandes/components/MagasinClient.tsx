...
export default function MagasinClient() {
  ...
  const motAvance = L("Avance", "\u0627\u0644\u062A\u0633\u0628\u064A\u0642");
  ...
  // Par defaut la vente est payee en entier. Le champ Avance ne sert que
  // dans le cas rare d'un paiement partiel.
  ...
  async function enregistrer(e: FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        setMessage(L("Vente enregistr\u00E9e", "\u062A\u0645 \u0627\u0644\u062A\u0633\u062C\u064A\u0644"));
