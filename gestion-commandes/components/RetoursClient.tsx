...
type Choix = { coche: boolean; quantite: number };
...
export default function RetoursClient() {
  ...
  async function enregistrer() {
    ...
    try {
      ...
      if (res.ok) {
        setMessage(
          L(
            "Retour enregistr\u00E9, articles remis au stock magasin",
            "\u062A\u0645 \u0627\u0644\u062A\u0633\u062C\u064A\u0644"
          )
        );
  ...
  async function annulerRetour(r: Retour) {
    const ok = window.confirm(
      L(
        "Annuler ce retour ? Les pieces repartiront du stock magasin.",
        "\u0625\u0644\u063A\u0627\u0621 \u061F"
      )
    );
    if (!ok) return;
  ...
  return (
    <div>
      ...
      >
        {L(
          "Les articles retourn\u00E9s reviennent automatiquement au stock du magasin. Si vous souhaitez les remettre en vente sur ounshijabi.com, ajoutez-les vous-m\u00EAme sur le site.",
          "\u062A\u0639\u0648\u062F \u0627\u0644\u0645\u0646\u062A\u062C\u0627\u062A \u0625\u0644\u0649 \u0645\u062E\u0632\u0648\u0646 \u0627\u0644\u0645\u062A\u062C\u0631"
        )}
      </div>
