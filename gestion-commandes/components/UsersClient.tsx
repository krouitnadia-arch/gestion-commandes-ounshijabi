...
export default function UsersClient() {
  ...
  return (
    <div>
      ...
      >
        <strong>Employ\u00E9e</strong> : acc\u00E8s complet aux Commandes, \u00E0 l&apos;Exp\u00E9dition,
        aux Retours et au Magasin. Le Stock est consultable mais non modifiable, et le tableau de
        bord n&apos;est pas affich\u00E9.
        <br />
        <strong>Administratrice</strong> : acc\u00E8s complet, y compris la modification du stock et
        le tableau de bord.
      </p>
