...
import { construireColis, etatCommande } from "@/lib/colisSendit";
import {
  listerDistricts,
...
// Un colis n'est considere comme disparu que si Sendit repond 404.
// En cas de panne reseau, on prefere croire qu'il existe encore, pour
  ...
  try {
    ...
    await prisma.order.update({
      ...
      data: {
        ...
        senditEtat: etatCommande(order, districtId) as any,
        saisiLivraison: true,
        statut: "EXPEDIEE",
      },
    });
