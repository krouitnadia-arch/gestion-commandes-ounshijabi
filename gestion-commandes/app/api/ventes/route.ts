...
export async function POST(req: NextRequest) {
  ...
  // ---------------------------------------------------------------
  // Verification du stock AVANT toute ecriture.
  // ---------------------------------------------------------------
  ...
  for (const e of entrees) {
    ...
    if (disponible <= 0) {
      return NextResponse.json(
        { error: `${produit.nom} : stock epuise, vente impossible` },
        { status: 400 }
      );
    }
  ...
  // Cas normal : la cliente paie la totalite. Le champ "avance" n'est rempli
...
export async function PATCH(req: NextRequest) {
  ...
  if (body.avance !== undefined) {
    ...
    // Le montant paye ne peut ni etre negatif ni depasser le total
