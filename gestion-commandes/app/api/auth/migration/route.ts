...
export async function GET(req: NextRequest) {
  // Deux facons d'autoriser la migration :
  // 1. etre connectee a l'application avec le compte administrateur
  // 2. ou fournir la cle : ?cle=SESSION_SECRET
  ...
  etapes.push("Colonnes commandes verifiees (dont fraisLivraison et statut RETOURNEE)");
