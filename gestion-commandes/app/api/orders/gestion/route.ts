...
export async function DELETE(req: NextRequest) {
  ...
  // Les pieces reviennent au stock avant la suppression, qu'il s'agisse
  // d'une commande du site ou d'une commande Instagram.
...
export async function POST(req: NextRequest) {
  ...
  // Les commandes absorbees sont supprimees sans rendre le stock :
