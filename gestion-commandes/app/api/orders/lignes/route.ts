...
export async function DELETE(req: NextRequest) {
  ...
  // Une ligne ajoutee a la main venait du magasin : elle y retourne.
  // Une ligne venue du site n'a jamais touche nos compteurs.
  const ajouteeAlaMain = Boolean(ligne?.productId) && !ligne?.variationId && !ligne?.produitId;
  if (ajouteeAlaMain) {
