...
export async function POST(req: NextRequest) {
  ...
  for (const e of entrees) {
    ...
    // Les pieces revenues entrent toujours au stock MAGASIN
...
export async function DELETE(req: NextRequest) {
  ...
  if (!id) return NextResponse.json({ error: "Retour introuvable" }, { status: 400 });
  ...
  // On annule le retour : les pieces ressortent du stock magasin
